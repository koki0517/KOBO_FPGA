...
set_property MARK_DEBUG true [get_nets CLK100M_IBUF_BUFG]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {LED_OBUF[10]}]]
...
connect_debug_port u_ila_0/probe2 [get_nets [list tx_OBUF]]
