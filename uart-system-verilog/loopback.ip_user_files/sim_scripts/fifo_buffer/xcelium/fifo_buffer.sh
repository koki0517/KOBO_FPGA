...
#
# Script generated by Vivado on Thu Jul 17 17:54:48 JST 2025
...
#
# Usage        : fifo_buffer.sh
#                fifo_buffer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_buffer.sh [-reset_run]
#                fifo_buffer.sh [-reset_log]
#                fifo_buffer.sh [-help]
#
...
#                script (type 'fifo_buffer.sh -help' for more information).
#
...
# script info
echo -e "fifo_buffer.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_buffer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_buffer xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_buffer -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_buffer_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fifo_buffer.sh [-step]\n\
Usage: fifo_buffer.sh [-lib_map_path]\n\
Usage: fifo_buffer.sh [-reset_run]\n\
Usage: fifo_buffer.sh [-reset_log]\n\
Usage: fifo_buffer.sh [-keep_index]\n\
